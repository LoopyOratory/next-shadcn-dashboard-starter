      ...
      <div className='flex flex-1 flex-col space-y-2'>
        ...
        <Tabs defaultValue='overview' className='space-y-4'>
          ...
          <TabsContent value='overview' className='space-y-4'>
            <StaggerContainer className='*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs sm:grid-cols-2 xl:grid-cols-4 lg:px-6'>
              <StaggerItem>
